...
import { Briefcase, FileText, Compass, Send, Search, Trash2, ClipboardCheck } from 'lucide-react';
        ...
        <div className="grid-cols-2">
          ...
          <div className="glass-card">
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '13px', lineHeight: '1.6', marginBottom: '20px' }}>
              Need advice on what skills to build, what projects to target, or major guidelines? Ask the advisor:
            </p>
            ...
            <div style={{ flex: '1', minHeight: '200px', display: 'flex', flexDirection: 'column' }}>
              {guidanceLoading ? (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: '1', gap: '12px' }}>
                  <div className="chat-loading">
                    <span>Advisor compiling strategy roadmap</span>
                  </div>
                </div>
              ) : guidanceResult ? (
