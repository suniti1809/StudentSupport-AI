...
> **A Generative AI-Powered Student Academic Assistant** built with **React, Flask, Python, SQLite, and Groq Llama 3.3**. StudentSupport AI leverages Large Language Models (LLMs) to deliver intelligent academic assistance, personalized learning support, and productivity tools through natural language conversations.
...
![LLM](https://img.shields.io/badge/LLM-Llama_3.3_70B-blueviolet?style=for-the-badge)
![Groq](https://img.shields.io/badge/Groq-Llama_3.3-F54E27?style=for-the-badge)
...
The application integrates the **Groq API** with the **Llama 3.3 70B Versatile Large Language Model (LLM)** to generate context-aware, real-time responses for academic queries. Instead of relying on predefined answers, the AI understands user prompts and generates personalized responses instantly.
...
- 🧠 AI-powered academic chatbot using **Groq Llama 3.3 70B Versatile**
...
4. Llama 3.3 70B processes the request.
...
```text
         ...
         │                       │
         ▼                       ▼
 SQLite Database         Groq Llama 3.3 API
         │                       │
         └───────────┬───────────┘
                     ▼
...
<p align="center">
Built with ❤️ using <strong>React</strong>, <strong>Flask</strong>, <strong>Python</strong>, <strong>SQLite</strong>, and <strong>Groq Llama 3.3 70B</strong>.
</p>
